...
RATES = [
    ...
    # выключатель: в книге курс весь период = 1, курсовой разницы не бывает.
    # Пока он выключен, все fx_income/fx_loss всегда 0 — как в книге.
    ("fx_enabled", "1", "Учитывать курсовую разницу", "Курс валют", "bool"),
