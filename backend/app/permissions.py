...
MODULES = [
    ...
    ("sales", "Продажа ГП"),
    ("prices", "Прайс-лист для покупателей"),
    ("payroll", "Зарплата"),
    ...
    # Сквозное право: не «раздел», а слой поверх остальных. Без него человек
    # видит документы и количества, но не деньги — цены, суммы, себестоимость.
    ("amounts", "Суммы и цены (деньги в документах)"),
